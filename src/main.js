...
import { showPrevProject, showNextProject } from './modules/workSlider'
...
// Skill Swiper
import { swiper } from './modules/skillSwiper'
...
document.querySelector(".swiper-wrapper").onmousemove = e => {
